...
public class SignUp extends javax.swing.JFrame {
    ...
    private void passwordRestrictions(String password) throws PasswordException {
        ...
        if (password.length() < minLength) {
            throw new PasswordException("Mật khẩu ít nhất phải là " + minLength + " ký tự.");
        }
        ...
        if (!matcher.find()) {
            throw new PasswordException("Mật khẩu phải chứa ít nhất một ký tự đặc biệt.");
        }
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (name1.isEmpty() || username1.isEmpty() || password1.isEmpty()) {
                String errorMessage = "Vui lòng điền vào (các) trường sau:";
                if (name1.isEmpty())
                    errorMessage += "\n- Họ và tên";
            ...
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "Tên đăng nhập đã tồn tại. Vui lòng chọn một cái khác.");
                return;
            }
            ...
            JOptionPane.showMessageDialog(null, "Mật khẩu lỗi: " + ex.getMessage());
        } catch (SQLException ex) {
            // Handle SQL exceptions
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Đã xảy ra lỗi khi tạo tài khoản: " + ex.getMessage());
        } catch (Exception ex) {
            // Handle other exceptions
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Đã xảy ra lỗi không mong muốn: " + ex.getMessage());
        }
