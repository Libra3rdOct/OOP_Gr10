...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (user_id.isEmpty() || pass.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Vui lòng điền vào cả hai trường tên người dùng và mật khẩu.");
            return;
        }
        ...
        try {
            ...
            ResultSet rs = DatabaseManager.executeQuery(
                    "SELECT * FROM users WHERE username = '" + user_id + "' AND password = '" + pass + "'");
            if (rs.next()) {
                JOptionPane.showMessageDialog(null,
                        "Chào mừng " + user_id + " tới Quản lí tài chính \n Bạn đã đăng nhập thành công ");
